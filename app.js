let initial_Title, initial_Description, initial_Button, score, Options;
initial_Title = document.getElementsByTagName("h1")[0];
initial_Description = document.getElementsByTagName("p")[0];
initial_Button = document.getElementsByTagName("button")[0];
score = 0;
...
let Questions = [
  ...
  "How many Oscars did Titanic won?",
...
function generateQuestion() {
  ...
  if (k != 11) {
    ...
    if (score == 10) {
      document.write(
        "Congratulations,you scored the maximum points " + score + " !"
      );
    } else if (score > 4 && score < 10) {
      document.write("Good job,you scored an excellent " + score + " points!");
    } else {
      document.write(
        "Sorry,your score is " + score + ",you'll do better next time!"
      );
    }
  }
